...
const Hero = () => {
  return (
    <section
      id="hero"
      className="bg-light dark:bg-gradient-to-br from-[rgb(161,92,56)] via-[rgba(161,92,56,1)] to-[rgba(245,204,158,1)] text-dark dark:text-white py-8"
    >
      <div className="container flex items-center gap-24">
        <div className="hero-text flex-1 flex flex-col gap-12">
        ...
        <div className="hero-img-container flex-1">
          <Image
            src={HeroImg}
